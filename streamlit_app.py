...
def generate_ev_station_data(state_names):
    ...
    states = gpd.read_file('/workspaces/electric_nation_stations/.github/data/cb_2018_us_state_500k.shp').to_crs('EPSG:4326')
    tribal = gpd.read_file('/workspaces/electric_nation_stations/.github/data/tl_2024_us_aiannh.shp').to_crs('EPSG:4326')
